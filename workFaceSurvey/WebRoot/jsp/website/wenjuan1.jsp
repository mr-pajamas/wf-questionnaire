        ...
        <div class="row">
          ...
          <div class="radio col-sm-4">
            ...
            <div style="margin-left: 65px;">
              <input type="text" name="q4-other" value="${user.positionother}" id="inputQ4Other" style="width: 100%;">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="radio col-sm-4">
            ...
            <div style="margin-left: 65px;">
              <input type="text" name="q8-other" value="${anwser.q8other}" id="inputQ8Other" style="width: 100%;">
            </div>
          </div>
        </div>
      </div>
