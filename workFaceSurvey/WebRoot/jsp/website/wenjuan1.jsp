...
<div class="container">
  ...
  <form class="form-horizontal" action="<%=webRoot %>/synthesize/SaveQ1" method="post">
        ...
        <div class="row">
          ...
          <div class="radio col-sm-4 check-other">
            ...
            <div style="margin-left: 65px;">
              <input type="text" name="q4-other" id="inputQ4Other" style="width: 100%;" disabled>
            </div>
          </div>
          -->
          <div class="radio col-sm-2">
      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="radio col-sm-4 check-other">
            ...
            <div style="margin-left: 65px;">
              <input type="text" name="q8-other" id="inputQ8Other" style="width: 100%;" disabled>
            </div>
          </div>
          -->
        </div>
      ...
      <div class="col-md-8">
        ...
        <div class="row">
          <div class="checkbox col-sm-4 check-other">
            ...
            <div style="margin-left: 65px;">
              <input type="text" name="q10-other" id="inputQ10Other" style="width: 100%;" disabled>
            </div>
          </div>
        </div>
        -->
    ...
    <div class="form-group">
      <label class="col-md-2 control-label">目前创业遇到最大的挑战</label>
      <div class="col-md-8">
        <div class="row">
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q10_add" value="商业模式" ${anwser.q9 eq '商业模式' ? 'checked' : ''}> 商业模式
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q10_add" value="资本运作" ${anwser.q9 eq '资本运作' ? 'checked' : ''}> 资本运作
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q10_add" value="团队管理" ${anwser.q9 eq '团队管理' ? 'checked' : ''}> 团队管理
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q10_add" value="其他" ${anwser.q9 eq '其他' ? 'checked' : ''}> 其他
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8 tags-input-group">
        <span id="q17Help" class="help-block">例如：复旦人、阿里系、南京人、媒体转型、编剧、IT背景、80后……</span>
        <input type="hidden" name="q17" class="tags-param" id="inputHiddenQ17" value="${user.tag}">
        <div class="row" style="margin-bottom: 10px">
          <div class="col-md-6">
            <!--<input type="text" class="form-control tags-input" id="inputQ17" aria-describedby="q17Help">-->
            <div class="input-group">
              <input type="text" class="form-control tag-input" id="inputQ17" aria-describedby="q17Help">
                <span class="input-group-btn">
                  <button class="btn btn-default tag-add" type="button">添加标签</button>
                </span>
            </div>
          </div>
        </div>
    ...
    <div class="form-group">
      <label class="col-md-2 control-label">（继上问）了解渠道</label>
      <div class="col-md-8">
        <div class="row">
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q20_add" value="公众号" ${anwser.q3 eq '公众号' ? 'checked' : ''}> 公众号
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q20_add" value="微信朋友圈" ${anwser.q3 eq '微信朋友圈' ? 'checked' : ''}> 微信朋友圈
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q20_add" value="朋友推荐" ${anwser.q3 eq '朋友推荐' ? 'checked' : ''}> 朋友推荐
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q20_add" value="壹道TV" ${anwser.q3 eq '壹道TV' ? 'checked' : ''}> 壹道TV
            </label>
          </div>
          <div class="radio col-sm-2">
            <label>
              <input type="radio" name="q20_add" value="其他" ${anwser.q3 eq '其他' ? 'checked' : ''}> 其他
            </label>
          </div>
        </div>
      </div>
...
-->
<script>
  initialTagsInput($(".tags-input-group"));
</script>
